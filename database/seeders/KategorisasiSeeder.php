...
class KategorisasiSeeder extends Seeder
{
    ...
    {
        $visiMisi = [
            ['visi_misi' => 'Jabar Adil Makmur Untuk Semua', 'kategori_isu' => 'Visi', 'paslon_id' => 1],
            ['visi_misi' => 'Bersama Jabar Maju Menuju Jabar Emas 2045', 'kategori_isu' => 'Visi', 'paslon_id' => 2],
            ['visi_misi' => 'Gerak cepat menuju Jakarta Unggul', 'kategori_isu' => 'Visi', 'paslon_id' => 3],
            ['visi_misi' => 'Jakarta semakin di depan', 'kategori_isu' => 'Visi', 'paslon_id' => 4],
            ['visi_misi' => 'Manusia Jabar yang sehat, terdidik, dan sejahtera', 'kategori_isu' => 'Kesehatan', 'paslon_id' => 1],
            ['visi_misi' => 'Jabar unggul dalam bidang inovasi dan teknologi', 'kategori_isu' => 'Teknologi', 'paslon_id' => 2],
            ['visi_misi' => 'Jakarta unggul dalam bidang inovasi dan teknologi', 'kategori_isu' => 'Teknologi', 'paslon_id' => 3],
            ...
            ['visi_misi' => 'Jakarta bangsa terhormat di kancah internasional, serta pertahanan yang tangguh dan modern', 'kategori_isu' => 'Keamanan dan Pertahanan', 'paslon_id' => 4],
            ...
            ['visi_misi' => 'Mewujudkan Manusia Jabar yang Sehat, Cerdas, Produktif, Berakhlak, dan Berbudaya', 'kategori_isu' => 'Kesehatan', 'paslon_id' => 2],
            ['visi_misi' => 'Mewujudkan Manusia Jakarta yang Sehat, Cerdas, Produktif, Berakhlak, dan Berbudaya', 'kategori_isu' => 'Kesehatan', 'paslon_id' => 4],
            ['visi_misi' => 'Mewujudkan Keluarga Jakarta yang Sejahtera dan Bahagia sebagai Akar Kekuatan Bangsa', 'kategori_isu' => 'Kesehatan', 'paslon_id' => 3],
            ['visi_misi' => 'Memperkuat Sistem Pertahanan dan Keamanan Negara, serta Meningkatkan Peran dan Kepemimpinan Jakarta dalam Arena Politik Global untuk Mewujudkan Kepentingan Nasional dan Perdamaian Dunia', 'kategori_isu' => 'Keamanan dan Pertahanan', 'paslon_id' => 3],
            ...
            ['visi_misi' => 'Memperkuat Sistem Pertahanan dan Keamanan Negara, serta Meningkatkan Peran dan Kepemimpinan Jabar dalam Arena Politik Global untuk Mewujudkan Kepentingan Nasional dan Perdamaian Dunia', 'kategori_isu' => 'Keamanan dan Pertahanan', 'paslon_id' => 1],
