        ...
        <div class="row">
            ...
            <div class="col-xl-8 ps-5 pt-xl-5 pt-3 pe-5">
                ...
                <div class="row pt-lg-5">
                    ...
                    <div class="col-lg-4 text-lg-end pt-lg-0 pt-3 text-center montserrat-semibold"><a href="{{ url('/detailberita') }}" class="btn align-items-center" style="background-color: #195A94; color: white; font-size: 13px;">Selengkapnya<img src="{{ asset('storage/images/element/vector-right.png') }}" class="ps-lg-2"></a></div>
                </div>
            </div>
        </div>
    </div>
