    ...
    <div class="col-12 p-xl-3 p-3 pt-4" style="background-color: rgba(246, 185, 81, 0.13); border-radius: 15px;">
        <div class="row">
            ...
            <div class="col-xl-8 ps-5 pt-xl-5 pt-3 pe-5">
                <p class="montserrat-semibold text-xl-start text-center" style="font-size: 22px; color: #195A94;">Sukses Pilkada Harus Kolaborasi Semua Pihak</p>
...
<div class="row m-xl-5 m-4">
    <div class="col-12 p-xl-3 p-3 pt-4" style="background-color: rgba(246, 185, 81, 0.13); border-radius: 15px;">
        <div class="row">
            <div class="col-xl-4 text-center p-xl-4"><img class="foto-berita" src="{{ asset('storage/images/berita/dummy-berita-1.png') }}" alt="logo berita1"></div>
            <div class="col-xl-8 ps-5 pt-xl-5 pt-3 pe-5">
                <p class="montserrat-semibold text-xl-start text-center" style="font-size: 22px; color: #195A94;">Menuju Pilkada 2024</p>
                <p class="montserrat-regular" style="font-size: 17px; text-align: justify;">Get inspired by this revived W.H. Auden’s Hymn to the United Nations. "Let music for peace Be the paradigm, For peace means to change At the right time, As the World-Clock, Goes Tick and Tock. So may the story Of our human city Presently move
                </p>
            </div>
        </div>
...
<div class="row pl-4 pr-4 m-xl-5 m-4">
    <div
        ...
        <div class="card p-4"
            ...
            <img class="card-img-top mx-auto foto-terkini" src="{{ asset('storage/images/berita/dummy-terkini-1.png') }}" alt="Card image cap">
            <div class="card-body">
                <h5 class="card-title montserrat-semibold" style="font-size: 22px;">Peraturan Mencoblos pada Pilkada 2024</h5>
                <div class="row pt-3">
                    <div class="col-5 d-flex align-items-center montserrat-regular"><i style="font-size: 20px;" class="bi bi-calendar2-event"></i><span class="ps-2" style="font-size: 13px;">24 Mei 2024</span></div>
                    <div class="col-7 text-end justify-content-end d-flex align-items-center">
                        <a href="#" class="btn montserrat-semibold px-3 py-2"
                            style="background-color: #F6B951; color: white; border-radius: 8px; font-size: 13px;">Selengkapnya<img src="{{ asset('storage/images/element/vector-right.png') }}"></a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div
        ...
        <div class="card p-4"
            style="box-shadow: 0 5px 15px rgba(0, 0, 0, 0.1); border-radius: 8px; width: 388px;">
            <img class="card-img-top mx-auto foto-terkini" src="{{ asset('storage/images/berita/dummy-terkini-2.png') }}" alt="Card image cap">
            <div class="card-body">
