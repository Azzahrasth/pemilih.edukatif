...
<div class="row mt-lg-5 mt-4 mb-5 justify-content-center">
    <div class="col-lg-8 col-md-10 col-sm-12 text-center">
        <img src="{{ asset('storage/images/partai/pks.png') }}" alt="Pemilih Edukatif" style="max-width: 250px;" class="my-4">
        <h2 class="poppins-bold">Partai Keadilan Sejahtera</h2> </br>
        <div>
        ...
        <div>
            ...
            <p class="poppins-regular" style="font-size: 20px; text-align: justify;">
                Partai Keadilan Sejahtera (PKS) berawal dari gerakan dakwah kampus yang menyebar di universitas-universitas Indonesia pada 1980-an, didorong oleh tokoh seperti Muhammad Natsir yang mendirikan Dewan Dakwah Islamiyah Indonesia (DDII) pada 1967. Gerakan ini berkembang pesat di kampus-kampus melalui Lembaga Dakwah Kampus (LDK) yang menggunakan sistem sel ala Ikhwanul Muslimin. Pada 1998, setelah jatuhnya Soeharto, para aktivis mahasiswa dari Kesatuan Aksi Mahasiswa Muslim Indonesia (KAMMI) mendirikan Partai Keadilan (PK). Meskipun KAMMI dan PK menyatakan tidak memiliki hubungan formal, keduanya berperan penting dalam pembentukan partai ini.
            </p> 
            <p class="poppins-regular" style="font-size: 20px; text-align: justify;">
