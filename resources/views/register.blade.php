...
<head>
    ...
    <title>Register | Pemilih Edukatif</title>
    ...
    <div class="poppins-regular container mt-5 mb-5 px-lg-1 px-4">
        ...
        <p class="text-end text-dark">
            ...
            <div class="col-lg-5 text-center mb-4">
                <h2 class="blue poppins-semibold text-start mt-4 mb-2">Daftar Sekarang,<br>Pilih Calon Pemimpin <br> Daerah Mu dengan Cerdas</h2>
                <img src="{{ asset('storage/images/logo2.png') }}" alt="Pemilih Edukatif Logo" class="img-fluid logo-background mt-3">
                
            </div>
            <div class="col-lg-6">
                <h3 class="yellow poppins-bold">HALLO SOBAT PELIF</h3>
            ...
            <p class= "text-start mt-4 mt-lg-1 ">Sudah memiliki akun?<br>Kamu bisa <a href="#">Masuk disini!</a></p>
        </div>
    </div>
